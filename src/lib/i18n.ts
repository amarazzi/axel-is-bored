...
export interface Translations {
  ...
  "home.heroDesc3": string;
  "home.heroDesc4": string;
  "home.seeAll": string;
...
const es: Translations = {
  ...
  "home.heroDesc2": ". Comparto lo que leo, veo y me encuentro por internet en",
...
const en: Translations = {
  ...
  "home.heroDesc2": ". I share what I read, watch and find online in",
