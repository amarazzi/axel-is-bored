...
const es: Translations = {
  ...
  "recomendaciones.subtitle": "Algunas de las cosas que estuve leyendo y viendo últimamente y quizás te gusten.",
...
const en: Translations = {
  ...
  "recomendaciones.subtitle": "Some of the things I've been reading and watching lately that you might enjoy.",
